...
def jfrogUpload() :
    ...
    url = 'http://54.165.165.168:8082/artifactory/example-repo-local/kubernetes-configmap-reload-0.0.1-SNAPSHOT.jar'
    file_path = '/var/lib/jenkins/workspace/DevopsJava/target/kubernetes-configmap-reload-0.0.1-SNAPSHOT.jar'
    username = 'admin'
    password = 'Pr@veen97' #replace 'your password with ur actual password'
